      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-4">
          ...
          <h2 className="text-4xl md:text-5xl font-bold leading-tight">
            {reviewed} / {target} <span className="text-2xl font-medium text-white/80">Words</span>
          </h2>
          <p className="text-white/80">Keep going! You are almost there.</p>
        </div>

        <div className="flex-shrink-0 bg-white/10 p-6 rounded-[2rem] backdrop-blur-md border border-white/20 text-center">
          <span className="block text-3xl font-bold">{progressPercent}%</span>
          <span className="text-sm text-white/70">Completed</span>
          <button className="mt-4 w-full px-6 py-2 bg-white text-primary rounded-xl font-bold hover:bg-opacity-90 transition-all shadow-lg">
            Review
          </button>
        </div>
      </div>
